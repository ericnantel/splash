...
SET SOURCE_FILE=%FILENAME%.CODE.Z80.ASM
SET ASSET_FOLDER=%FILENAME%.ASSETS
SET ROUTINE_FOLDER=%FILENAME%.ROUTINES
SET RUNTIME_FOLDER=%FILENAME%.RUNTIMES
...
MOVE %ASSET_FOLDER% TOOLCHAIN
MOVE %ROUTINE_FOLDER% TOOLCHAIN
MOVE %RUNTIME_FOLDER% TOOLCHAIN
CD TOOLCHAIN
MOVE %INCLUDE_FILE% TASM
MOVE %SOURCE_FILE% TASM
MOVE %ASSET_FOLDER% TASM
MOVE %ROUTINE_FOLDER% TASM
MOVE %RUNTIME_FOLDER% TASM
CD TASM
...
RMDIR /S /Q ..\CACHE\%ASSET_FOLDER%
MOVE %ASSET_FOLDER% ..\CACHE
RMDIR /S /Q ..\CACHE\%ROUTINE_FOLDER%
MOVE %ROUTINE_FOLDER% ..\CACHE
RMDIR /S /Q ..\CACHE\%RUNTIME_FOLDER%
MOVE %RUNTIME_FOLDER% ..\CACHE
